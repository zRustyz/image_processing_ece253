...
def main():
    ...
    for i in range(1, 8):
        image_path = f"outputs/{i}/blurry.png"
        ...
        wiener_deblur_color(image, kernel, nsr_estimate, output_path=f"outputs/{i}/wiener_result_blurry.png")
        inverse_deblur_color(image, kernel, output_path=f"outputs/{i}/inverse_result_blurry.png")
